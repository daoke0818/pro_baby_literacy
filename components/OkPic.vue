  ...
  data() {
    return {
      okPic: {
        ...
        empty: '1x1px.png',
        level1: [/*'p_pass09_JSON.jpg',*/ 'p_level2_mengMengJi.png', 'p_level_baby.png', 'p_level_bear.png', 'p_level_monkey.png'],
        level2: ['p_pass10_JSON.jpg', 'p_level2_maTong.jpg', 'p_level2_niuChe.jpg', 'p_level2_xiaoDuGuo.jpg', 'p_level2_musicFengLing',
          'p_level2_ElevaNaiFen', 'p_level2_diQiuYi.png', 'p_level2_moTuoChe', 'p_level2_lanQiuJia', 'p_level2_wanXiangChe'],
